...
save.image(file=paste(OutDIR,"/RL_myPairs_PHONE_jarowinkler.RData",sep=""))
...
save.image(file=paste(OutDIR,"/RL_myPairs_EMAIL_PHONE_jarowinkler.RData",sep=""))
...
#    thisPair = compare.dedup(input_df, blockfld = blocklist[[b_idx]], exclude=1, strcmp=TRUE, strcmpfun=jarowinkler)
    load(paste("/home/chen/workspace/git_examples/PatientMatching/meta7/RL_Block_blockID_", blockID, "_jarowinkler.RData", sep=""))
