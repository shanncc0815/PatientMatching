...
VotingOutDIR = "/home/chen/workspace/git_examples/PatientMatching/meta7/Voting_v1/"
#dir.create(OutDIR)
...
# it's worse...
removeFIELD = c(5,9,10,11,13,14,17)
allPairs$frequencies = allPairs$frequencies[-removeFIELD] 
allPairs$pairs = allPairs$pairs[,-c(removeFIELD+2)]
...
for(i in 1:RandTotal) {
    ...
    FNList[[i]]=FN
    FPList[[i]]=FP
#    save(FN, FP, file=paste(VotingOutDIR, "trainSupv_bagging_",META[meta_flag],"_randomSeed",i,".RData",sep=""))    
