...
VotingInDIR = "/media/chen/4TB/PatientMatching/meta8/Voting_v6/"
VotingOutDIR = "/media/chen/4TB/PatientMatching/meta8/Voting_v8/"
...
# source("src/AggregateVoting_V8F2.r")
