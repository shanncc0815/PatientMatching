...
save(Identity, file="/home/chen/workspace/git_examples/PatientMatching/meta6/RL_Identity_EMAIL.RData")

save.image(file="/home/chen/workspace/git_examples/PatientMatching/meta6/uspsAddress_RL_Identity_EMAIL_0801_2017.RData")
print(format(Sys.time(), "%H:%M:%S"))
