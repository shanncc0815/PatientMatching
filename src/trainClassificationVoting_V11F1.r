...
load("/media/chen/4TB1/PatientMatching/meta11/RL_Identity_Simplified_v4_WholeImage.RData")
sub_df$PHONE2 = NULL
...
save.image(file="/media/chen/4TB1/PatientMatching/meta11/RL_myPairs_jarowinkler_V11.RData")
...
library(RecordLinkage)
options(width=100)
load("/media/chen/4TB1/PatientMatching/meta11/RL_myPairs_jarowinkler_V11.RData")
...
VotingOutDIR = "/media/chen/4TB1/PatientMatching/meta11/"
RandTotal = 161
...
#    save(FN, FP, model, file=paste(VotingOutDIR, "trainSupv_bagging_jarowinkler_randomSeed",i,".RData",sep=""))
    ...
    save(model, file=paste(VotingOutDIR, "trainSupv_bagging_jarowinkler_randomSeed",i,".RData",sep=""))
