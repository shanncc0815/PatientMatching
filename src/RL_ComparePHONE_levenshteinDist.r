...
allPairs$pairs$PHONE = (PHONE_MAP[allPairs$pairs$id1,2] != PHONE_MAP[allPairs$pairs$id2,2]) * 10
...
save.image(file=paste(OutDIR,"/RL_myPairs_PHONE_0802_2017.RData",sep=""))
...
load("/home/chen/workspace/git_examples/PatientMatching/meta6/PHONE_dict.RData")
load("/home/chen/workspace/git_examples/PatientMatching/meta7/RL_myPairs_EMAIL_0802_2017.RData")
...
save.image(file=paste(OutDIR,"/RL_myPairs_EMAIL_PHONE_0802_2017.RData",sep=""))
...
#    thisPair = compare.dedup(input_df, blockfld = blocklist[[b_idx]], exclude=1, strcmp=TRUE, strcmpfun=levenshteinDist)
    load(paste("/home/chen/workspace/git_examples/PatientMatching/meta7/RL_Block_blockID_", blockID, ".RData", sep=""))
    thisPair$pairs$PHONE = (PHONE_MAP[thisPair$pairs$id1,2] != PHONE_MAP[thisPair$pairs$id2,2]) * 10
    save(thisPair, file=paste(OutDIR,"/RL_Block_blockID_", blockID, ".RData", sep=""))
    rm(thisPair)
}
