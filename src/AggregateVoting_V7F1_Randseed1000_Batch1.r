...
write(Out, file = "submit010_Vote1000_V7F1.csv", append = FALSE, sep = " ")
...
#save.image(file=paste(VotingOutDIR, "AggregateVoting_V7F1_Randseed1000.RData",sep=""))

save(VotingPredict, unionPair, EID, VotingOutDIR, file=paste(VotingOutDIR, "AggregateVoting_V7F1_Randseed1000_VotingPredict_Batch1.RData",sep=""))
