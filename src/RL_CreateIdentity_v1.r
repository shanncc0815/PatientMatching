...
set2 = diffPair("../submit/submit054_sameDOB2_exhaust.csv","../submit/PosSet006.csv","../submit/NegSet006.csv")
set3 = diffPair("../submit/submit055_sameDOB3_exhaust.csv","../submit/PosSet007.csv","../submit/NegSet007.csv")
set4 = diffPair("../submit/submit056_sameDOB4_exhaust.csv","../submit/PosSet008.csv","../submit/NegSet008.csv")
set5 = diffPair("../submit/submit057_sameDOB5_exhaust.csv","../submit/PosSet009.csv","../submit/NegSet009.csv")
...
# submit/sameEMAIL_AllFP.csv is another matrix
...
#      mylist[[thisID]] = union(mylist[[thisID]], c(AllPos$V1[i], AllPos$V2[i]))
  ...
  if(i %% 100 == 2) {
    ...
    t3 = length(which(a == 3))
    t4 = length(which(a == 4))
    print( paste(format(Sys.time(), "%H:%M:%S")," ",i,":"," Count2=",t2,",Count3=",t3," ,Count4=",t4,sep="") )
  }
}
...
save(Identity, file="/home/chen/workspace/git_examples/PatientMatching/meta6/RL_Identity_V2.RData")
save.image(file="/home/chen/workspace/git_examples/PatientMatching/meta6/uspsAddress_RL_Identity_0801_2017.RData")
...
save.image(file="/home/chen/workspace/git_examples/PatientMatching/meta6/uspsAddress_RL_Identity_0801_2017_v1.RData")
